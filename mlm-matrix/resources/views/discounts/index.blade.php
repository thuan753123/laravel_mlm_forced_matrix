...
@section('title', 'Chiết khấu theo Bậc')
            ...
            <div class="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
                <div>
                    <h1 class="text-3xl md:text-4xl font-bold text-gray-900 mb-2">
                        <i class="fas fa-percentage text-blue-600 mr-3"></i>Bảng Chiết khấu
                    </h1>
                    <p class="text-gray-600">Thông tin chiết khấu theo bậc doanh thu NPP</p>
                </div>
                <a href="{{ route('discounts.calculator') }}" 
