...
@section('title', 'Sửa Bậc Chiết khấu')
...
<div class="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100 p-4 md:p-6 lg:p-8">
            ...
            <div class="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
                <div>
                    <h1 class="text-3xl md:text-4xl font-bold text-gray-900 mb-2">
                        <i class="fas fa-edit text-blue-600 mr-3"></i>Sửa Bậc Chiết khấu
                    </h1>
                    <p class="text-gray-600">Chỉnh sửa cấu hình chiết khấu</p>
                </div>
    ...
    <div class="max-w-4xl mx-auto">
        <form action="{{ route('admin.discounts.update', $tier->id) }}" method="POST" class="bg-white rounded-2xl shadow-lg overflow-hidden">
            @csrf
            @method('PUT')
            ...
            <div class="p-6 md:p-8 space-y-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                        ...
                        <input type="number" 
                               id="revenue_from" 
                               name="revenue_from" 
                               value="{{ old('revenue_from', $tier->revenue_from) }}"
                               min="0"
                               step="0.01"
                    ...
                    <div>
                        ...
                        <input type="number" 
                               id="revenue_to" 
                               name="revenue_to" 
                               value="{{ old('revenue_to', $tier->revenue_to) }}"
                               min="0"
                               step="0.01"
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                        ...
                        <input type="number" 
                               ...
                               value="{{ old('applicable_revenue_from', $tier->applicable_revenue_from) }}"
                               min="0"
                               step="0.01"
                    ...
                    <div>
                        ...
                        <input type="number" 
                               ...
                               value="{{ old('applicable_revenue_to', $tier->applicable_revenue_to) }}"
                               min="0"
                               step="0.01"
                               placeholder="Để trống nếu không giới hạn"
                ...
                <div>
                    ...
                    <input type="number" 
                           id="discount_rate" 
                           name="discount_rate" 
                           value="{{ old('discount_rate', $tier->discount_rate) }}"
                           min="0"
                           max="100"
                           step="0.01"
                ...
                <div>
                    ...
                    <textarea id="note" 
                              ...
                              class="block w-full px-4 py-3 border-2 border-gray-300 rounded-xl focus:ring-4 focus:ring-gray-100 focus:border-gray-500 transition-all duration-200 @error('note') border-red-500 @enderror">{{ old('note', $tier->note) }}</textarea>
                    @error('note')
                        <p class="mt-2 text-sm text-red-600"><i class="fas fa-exclamation-circle mr-1"></i>{{ $message }}</p>
                    @enderror
                </div>
                ...
                <div>
                    <label class="flex items-center cursor-pointer">
                        ...
                        <span class="ml-3 text-sm font-semibold text-gray-700">
                            <i class="fas fa-toggle-on text-blue-500 mr-2"></i>Kích hoạt
                        </span>
                    </label>
                    <p class="mt-2 ml-8 text-sm text-gray-600"><i class="fas fa-info-circle mr-1"></i>Bậc chỉ có hiệu lực khi được kích hoạt</p>
                </div>
            </div>
            ...
            <div class="px-6 py-4 bg-gray-50 border-t border-gray-200 flex items-center justify-end space-x-4">
                ...
                <button type="submit" 
                        class="inline-flex items-center px-8 py-3 bg-gradient-to-r from-blue-600 to-blue-700 hover:from-blue-700 hover:to-blue-800 text-white font-bold rounded-xl shadow-lg hover:shadow-xl transform hover:-translate-y-0.5 transition-all duration-200">
