<?php $__env->startSection('title', 'Cấu hình MLM'); ?>
...
function loadCurrentConfig() {
    ...
    $.ajax({
        url: '<?php echo e(route("admin.config.index")); ?>',
        method: 'GET',
        headers: {
...
function resetConfig() {
    Swal.fire({
        ...
        if (result.isConfirmed) {
            ...
            $.ajax({
                url: '<?php echo e(route("admin.config.reset")); ?>',
                method: 'POST',
                headers: {
                    'X-Requested-With': 'XMLHttpRequest',
                    'Accept': 'application/json'
...
function performSave(configData) {
    ...
    $.ajax({
        url: '<?php echo e(route("admin.config.update")); ?>',
        method: 'POST',
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/kentpc/Documents/GitHub/laravel_mlm_forced_matrix/mlm-matrix/resources/views/admin/config.blade.php ENDPATH**/ ?>