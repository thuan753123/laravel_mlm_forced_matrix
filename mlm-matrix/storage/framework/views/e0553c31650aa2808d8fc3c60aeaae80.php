        ...
        <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
            <div class="p-6 text-gray-900">
                <div class="text-center py-12">
                    ...
                    <h1 class="text-2xl font-bold text-gray-900 mb-4"><?php echo e(__('ui.matrix_page.heading')); ?></h1>
                    ...
                    <div class="bg-gray-50 rounded-lg p-4 mb-6">
                        <div class="grid grid-cols-1 md:grid-cols-3 gap-4 text-center">
                            <div>
                                ...
                                <p class="font-semibold text-gray-900"><?php echo e($user->fullname ?? 'Chưa cập nhật'); ?></p>
                            </div>
                            <div>
                            ...
                            <div>
                                ...
                                <p class="font-semibold text-indigo-600"><?php echo e($user->referral_code); ?></p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="max-w-md mx-auto">
                            ...
                            <div class="flex">
                                ...
                                <div class="ml-3">
                                    <p class="text-sm text-yellow-800">
                                        <?php echo e($message ?? 'Bạn chưa được đặt trong ma trận MLM.'); ?>
                        ...
                        <div class="space-y-4">
                            ...
                            <div class="flex flex-col sm:flex-row gap-3 justify-center">
                                ...
                                <a href="<?php echo e(route('matrix.index')); ?>"
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/kentpc/Documents/GitHub/laravel_mlm_forced_matrix/mlm-matrix/resources/views/matrix/waiting.blade.php ENDPATH**/ ?>